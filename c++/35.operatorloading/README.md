...
In operator Overloading we can change the behavious of the operator.
...
int main()
{
	...
	std::cout << result2 << std::endl;//This we cant do
	return 0;
}
```

Now the code looks simpler and cleaer.

So we can even overload the << operator of cout;
